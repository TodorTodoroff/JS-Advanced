...
const detailsTemplate = (pet, donations, hasUser, isOwner, canDonate, onDelete, onDonate) => html`
...
export async function showDetails(ctx) {
    ...
    ctx.render(detailsTemplate(pet, donations * 100, hasUser, isOwner, canDonate, onDelete, onDonate));
